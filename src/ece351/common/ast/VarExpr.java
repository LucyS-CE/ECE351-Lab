...
public final class VarExpr extends Expr {
	...
	public boolean equals(final Object obj) {
		...
		if (!getClass().equals(obj.getClass())) return false;	// only compare same class
		final VarExpr that = (VarExpr) obj;
		// compare field values
		// TODO: short code snippet
		return this.identifier.equals(that.identifier);	  // here the equals() is from java.lang.String since identifier is a String
