...
// throw new ece351.util.Todo351Exception();
	...
	SymmetryBreaker[] constructSymmetryBreakers() {
		...
		// TODO: short code snippet
		result[0] = new SymmetryBreaker(6, null);
		result[1] = new SymmetryBreaker(6, result[0]);
		return result;
// throw new ece351.util.Todo351Exception();
	}
	...
	TransitivityBreaker[] constructTransitivityBreakers() {
		...
		// TODO: short code snippet
		result[0] = new TransitivityBreaker(6.0);
		result[1] = new TransitivityBreaker(6.0 + epsilon6);
		result[2] = new TransitivityBreaker(6.0 + 2 * epsilon6);
		return result;
// throw new ece351.util.Todo351Exception();
	}
