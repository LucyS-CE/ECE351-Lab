...
// throw new ece351.util.Todo351Exception();
    ...
    public Rule Formula() {
        return Sequence(W0(), Var(), W0(), "<=", W0(), Expr(), W0(), ';', W0());
    }

    public Rule Expr() {
        return Sequence(W0(), Term(), W0(), ZeroOrMore(Sequence(W0(), "or", W0(), Term())));
    }

    public Rule Term() {
        return Sequence(W0(), Factor(), W0(), ZeroOrMore(Sequence(W0(), "and", W0(), Factor())));
    }
    ...
    public Rule Var() {  
        return Sequence(W0(), OneOrMore(Id()));
    }
