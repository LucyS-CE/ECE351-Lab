...
public final class WProgram implements Examinable {
	 ...
	 * @param var
	 * @param time
	 * @throws IllegalArgumentException if the named waveform or the named time does
	 *                                  not exist.
	 * @return
	 */
	...
	/**
	 * Construct a new WProgram with all of this WProgram's waveforms plus the
	 * parameter.
	 * 
	...
	public String toString() {
		...
		List<String> waveform_list = new ArrayList<>();
		for (Waveform w : waveforms) {
			waveform_list.add(w.toString()); // use the toString() wrote in Waveform.java to create a list
		}
		return String.join(System.lineSeparator(), waveform_list);
